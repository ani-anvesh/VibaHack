          ...
          <div className="card">
            ...
            <div className="back">
              ...
              <span className="shiva">
                ...
                analyze the data and make meaningful decisions for the welfare
                of business and society. AI / ML has seen its presence in
                domains like health care, agriculture, research etc.
              </span>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="back">
              ...
              <span className="shiva">
                ...
                production of data and capabilities to transfer it to
                appropriate centers for analysis and production has seen
                exponential growth. With the emergence of IOT , people can
                easily control the environment as per their needs. All the
                electronic gadgets which are manufactured are somehow connected
                to internet.
              </span>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="back">
              ...
              <span className="shiva">
                ...
                technology which is highly secure,distributive and
                decentralized. Plethora of applications are emerging in this
                domain.
              </span>
            </div>
          </div>
